...
for jj=1:trials % Perform trials
    ...
    for n=1:nmax % Compute complexity for each n
        ...
        while 1
            ...
            winnowClassifier=myWinnow(X(1:m,:),y(1:m,:)); % Initiallize a classfier on m samples
            yy=winnowClassifier.evalwinnow(X);% Evaluate on g_er_size samples
